...
> * [扫雷（一）游戏入口（概念及准备）](/post/2016/06/17/minesweeper/1)
> * [扫雷（二）排行榜（定义和使用函数、对象）](/post/2016/06/20/minesweeper/2)
> * [扫雷（三）雷区（元素定位、事件代理、背景图片）](/post/2016/06/30/minesweeper/3)
> * [扫雷（四）雷区完善（递归打开、随机布雷）](/post/2016/07/01/minesweeper/4)
...
![排行榜成功存储](/images/2016/minesweeper/2-rank-f12.png)
...
![尝试调用接口](/images/2016/minesweeper/2-rank-api.png)
