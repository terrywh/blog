...
* 安装版本更新时间：2026-09-07 [gcc](https://gcc.gnu.org/releases.html)(16.2) / [llvm](https://github.com/llvm/llvm-project/releases)(23.1.1)
...
* 相关参数参考：https://llvm.org/docs/CMake.html
    ...
    ``` bash
    wget https://github.com/llvm/llvm-project/releases/download/llvmorg-23.1.1/llvm-project-23.1.1.src.tar.xz
    tar xf llvm-project-23.1.1.src.tar.xz
    cd llvm-project-23.1.1.src
    # project
