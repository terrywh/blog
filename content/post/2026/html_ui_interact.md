...
> 写了这么久的 HTML 竟然都不知道内置能力已经非常不错了，结合 [htmlx](https://four.htmx.org/patterns#loading) 完全可以将绝大部分简单交互覆盖到；几乎不用写 JS 了，👍👍
...
------------------------------
## 四、 滚动与多媒体交互类（Scrolling & Media）

## 8. scroll-snap 声明式滚动吸附
